...
function Navbar2({scrollToAbout, scrollToHome}) {
  return (
        <Navbar collapseOnSelect expand="lg" className="justify-content-between bg_dark p-2 sticky-top collapse_border">
           ...
           <Navbar.Collapse id="responsive-navbar-nav" >
             <Nav className="mx-auto text-center">
               <Link to="/home" className="text-decoration-none text-white mx-4 my-2 ">
                 <span className="nav-link-text" onClick={scrollToHome}>Home</span>
               </Link>
