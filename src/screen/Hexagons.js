...
const Hexagons = () => {
  return (
    <div className="row d-flex justify-content-around pt-5 position-relative bg_dark">
      <h1 className="text-center text_main mb-5 h1_border_bottom fw-bold">Cosa Offro</h1>
          <div className="col-12 col-sm-6 col-lg-3 d-flex align-items-center flex-column py-3 px-2">
